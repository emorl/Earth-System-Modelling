...
def predict_ts(data, config, n_days=None):
    ...
    moists, runoffs, runoffs_s, runoffs_h, runoffs_ice, ets = np.zeros(n_days), np.zeros(n_days), np.zeros(n_days), np.zeros(n_days), np.zeros(n_days), np.zeros(n_days)
